...
var trackerData_Timestamp = '02/21/18 | 5:45pm';
...
function initMap(aws_latitude, aws_longitude)
{
	...
	map_Obj = new google.maps.Map(document.getElementById( 'map' ), {
		center: new google.maps.LatLng( aws_latitude, aws_longitude ),
        zoom: 12,
    ...
    var map_Tracker_Marker = new google.maps.Marker({
        position: new google.maps.LatLng( aws_latitude, aws_longitude ),
        map: map_Obj,
